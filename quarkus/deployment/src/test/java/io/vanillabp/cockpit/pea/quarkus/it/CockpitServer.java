...
public final class CockpitServer {
  ...
  private static Request await(
      final Supplier<Stream<Request>> candidates,
      final String failure) {

    // the same patience the Spring Boot test of this repository has: an outbox entry is
    // dispatched by a poller, and a loaded machine takes its time
